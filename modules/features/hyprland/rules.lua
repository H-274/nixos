-- From https://github.com/fufexan/dotfiles/blob/main/system/programs/hyprland/rules.lua
--------------------------
---- LAYER RULES ---------
--------------------------
...
hl.layer_rule({
    match = {
        namespace = "^(quickshell:notifications:overlay|quickshell:osd)$"
    },
    ignore_alpha = 0.2
})
hl.layer_rule({
    match = {
        namespace = "^(vicinae|logout_dialog|quickshell:sidebar|quickshell:popup)$"
    },
    ignore_alpha = 0.5
})
hl.layer_rule({
...
hl.layer_rule({
    match = {
        namespace = "^(quickshell:notifications:overlay|quickshell:sidebar|quickshell:popup)$"
    },
    no_anim = true
})
...
hl.window_rule({
    match = {
        class = "^(.*jetbrains.*)$",
        title = "^(Confirm Exit|Open Project|win424|win201|splash)$"
    },
    center = true
})
hl.window_rule({
...
hl.window_rule({
    match = {
        class = "MATLAB",
        title = "DefaultOverlayManager.JWindow"
    },
    no_anim = true
})
hl.window_rule({
...
hl.window_rule({
    match = {
        class = "^(zen|firefox|chromium-browser|chrome-.*)$"
    },
    scroll_touchpad = 0.1
})
hl.window_rule({
